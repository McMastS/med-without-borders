...
// TODO Add quotes to short story, find better picture, make it pretty
const Homepage = () => {
  return (
	  <div className="tc">
				  ...
				  <div className="cover bg-left bg-center-l background">
				    <div className="bg-black-80 pb5 pb6-m pb7-l">
				      ...
				      <div className="tc-l mt4 mt5-m mt6-l ph3">
				        ...
				        <Link to="/signin"><a className="f6 no-underline grow dib v-mid white bg-red ba b--red ph3 pv2 mb3" href="">I need medicine</a></Link>
				        <span className="dib v-mid ph3 white-70 mb3">or</span>
				        <Link to="/signin"><a className="f6 no-underline grow dib v-mid white ba b--white ph3 pv2 mb3" href="">I have medicine</a></Link>
				      </div>
				    </div>
				  </div> 
				</header>
